...
//          << "The constant 'zInvLn10F' is wrong.";
      ...
      std::cout << std::scientific << std::setprecision(std::numeric_limits<float>::max_digits10) << pi << std::endl;
      std::cout << std::scientific << std::setprecision(std::numeric_limits<float>::max_digits10) << results[0] << std::endl;
//      EXPECT_FLOAT_EQ(pi / 2.0f, results[index++])
