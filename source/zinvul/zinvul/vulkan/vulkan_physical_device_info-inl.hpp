...
#ifndef ZINVUL_VULKAN_PHYSICAL_DEVICE_INFO_INL_HPP
#define ZINVUL_VULKAN_PHYSICAL_DEVICE_INFO_INL_HPP
...
VulkanPhysicalDeviceInfo::VulkanPhysicalDeviceInfo(
    zisc::pmr::memory_resource* mem_resource) noexcept :
        extension_properties_list_{mem_resource},
        layer_properties_list_{mem_resource},
        queue_family_properties_list_{mem_resource}
{
}
...
/*!
  */
inline
void VulkanPhysicalDeviceInfo::fetch(const vk::PhysicalDevice& device) noexcept
{
...
#endif // ZINVUL_VULKAN_PHYSICAL_DEVICE_INFO_INL_HPP
